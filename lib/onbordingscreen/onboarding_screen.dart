...
import 'package:task1/onbordingscreen/OnboardingInfomode.dart';
            ...
            itemBuilder: (context,index){
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    //Images
                    Image.network(controller.items[currentIndex].image),
  ...
  Widget button(){
    return Container(
      ...
      child: TextButton(
        onPressed: (){
          setState(() {
            currentIndex != controller.items.length -1? currentIndex++ : Navigator.pushReplacement(
              context,
